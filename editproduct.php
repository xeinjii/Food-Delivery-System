...
<nav class="navbar navbar-expand-lg bg-dark-subtle fixed-top">
 ...
 ?>
    ...
    <form action="" method="post" enctype="multipart/form-data">
         ...
         <div class="form-floating mb-3">
            <input type="number" class="form-control" id="Quantity" name="Quantity" value="<?php echo $row['Quantity']; ?>" min="0" step="1" placeholder="Product price" required>
        ...
        <label for="floatingPassword">Select category</label>
         ...
         <div>
         <a class="btn btn-secondary me-5" href="adminpage.php">Cancel</a>
         </div>
